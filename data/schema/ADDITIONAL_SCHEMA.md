...
**進捗は `meta.status.phases` を参照（このファイル自体はフィールド構造・カテゴリ・数え方の基準を定義するドキュメント）。2026-07-17時点で1〜6節（即位経路・改元・大赦・立后・皇太子廃立・遷都）は364人全員完了、7〜9節（親征・反乱鎮圧・被反乱）は調査中、10節（年齢）は悉皆調査中。**
