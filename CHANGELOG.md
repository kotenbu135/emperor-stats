...
- `yuan-shizu.personalCampaignCount`（3件）→ **high**。元史 巻四～巻十七（世祖一～十四）の全文へ
  「亲征／自将／亲率／亲将／亲讨／车驾亲征」等を機械で悉皆走査し、**帝を主語とする用例が計上済みの4箇所
  （阿里不哥2・乃颜・海都）以外に存在しない**ことを確認した（残る「亲率」1箇所は将帥・阿术が主語）。
  計上基準（原文に直接記載のある遠征のみ）の範囲内で悉皆性を機械で示せる
- `yuanmo-xushouhui.personalCampaignCount`（0件）→ **medium**。明史巻123・新元史巻226 しか読んでいなかった
  ので **元史 巻三十八～巻四十七（順帝本紀）を第3の史料として追加で読んだ**。順帝本紀は
  「徐寿辉遣伪将○○陷△△」「徐寿辉兵陷○○」の書式で**本人出征の有無を書き分けない**。加えて新元史巻226 に
  至正13年11月の蘄水攻防で「寿辉出战，大败，遁入黄梅山」があり、**本人が戦闘に出た可能性を示す唯一の記述**。
  防戦であって出征ではなく「自将」「亲率」等の統軍語を伴わず、明史・元史は本人の出戦に触れないため
  0件は維持したが、境界事例が1件あり史料間で書き方が割れるため high とはしない
- `yuanmo-xushouhui.rebellionSuppressionCount`（0件）→ **medium**。0件の根拠は「倪文俊の弑逆未遂を誰が
  阻んだか」を明記する史料が無いことで、明史・新元史・元史順帝本紀の3史料はいずれも「不果／不克」とのみ書く。
  **沈黙からの推論**なので high は出ない
- `yuanmo-xushouhui.rebellionSufferedCount`（2件）→ **high**。倪文俊の弑逆未遂・陳友諒の簒奪の2件は
  上記3史料が一致して記録し、在位10年に他の対寿輝反乱は3史料のいずれにも現れない
