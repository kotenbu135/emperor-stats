...
// 統合パッケージ radix-ui から引く（個別パッケージは入れない）。
  ...
  switch (tabVariant) {
    case 'line':
      return cx(
        ...
        // hover
        'hover:text-foreground hover:dark:text-gray-400',
        // border hover
        'hover:border-border hover:dark:border-gray-400',
        // selected
        ...
        'data-[disabled]:text-gray-300 data-[disabled]:dark:text-foreground',
      );
    case 'solid':
      return cx(
        // base
        ...
        // hover
        'hover:text-foreground hover:dark:text-gray-200',
        // ring
        'ring-transparent',
        // selected
