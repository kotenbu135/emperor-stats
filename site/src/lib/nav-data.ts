...
export const navCategories: NavCategory[] = [
  ...
  // 系譜図は 2026-08-17 の版を出来が公開に耐えないと判断して同日取り下げた（Issue #174）
  // 経緯があり、2026-08-19 に「一般的な家系図のつなぎ方」で作り直してユーザー承認のうえ
  // 再公開した。**shortLabel は付けない** — モバイルヘッダーは3項目で満杯
  // （下の mobileNavCategories のコメント）。モバイルの出口はトップの「次に見る」カード。
