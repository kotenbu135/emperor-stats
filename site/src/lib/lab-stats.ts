...
// 採用が決まった候補は emperors.ts へ移し、ここから消す（候補7 同時在位数・
// 候補8 在位継続率は 2026-08-01 に移動済み）。
//
...
// ---------------------------------------------------------------- 日付ユーティリティ
//
// スクリプトの iso_y2() の写し。**ユリウス通日を使う集計（同時在位数）は
// 2026-08-01 に emperors.ts へ移した**ので、ここに残っているのは年だけを見る側。
