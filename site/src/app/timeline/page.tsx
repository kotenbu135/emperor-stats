      ...
      >
        <ul className="max-w-3xl list-disc space-y-2 pl-5 text-sm leading-relaxed text-foreground/90">
          ...
          <li>
            ...
            「在位する皇帝がただ一つの王朝にのみいる期間」を在位データから機械的に求めたものです。歴史的な領土の統一とは一致しない場合があります（例：東晋371–383年は華北を統一した前秦の苻堅が「天王」を称して皇帝でなかったため、南宋1235–1259年は金滅亡後のモンゴルが皇帝を称さなかったため、満洲国1934–45年は溥儀が唯一の皇帝だったため、いずれも「統一」側になります）。
          </li>
          <li>
            <strong>上下の配置</strong>
