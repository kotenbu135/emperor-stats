...
export const KINSHIP_CHAPTERS: KinshipChapter[] = [
  ...
  },
  {
    ...
    // 章の切れ目の但し書き。東晋の元帝は西晋の宗室（司馬懿の曾孫）。実父の司馬覲と
    // 実母の夏侯光姫は「三国・西晋」の章にも出ているが、西晋との血のつながりが図で
    // 読めるよう客人 (d) 型としてこの章にも出す（2026-08-21 ユーザー指摘）。
    note: "東晋の元帝は西晋の一族（司馬懿の曾孫）。実父の司馬覲と実母の夏侯光姫は「三国・西晋」の章にも出ているが、西晋との血のつながりを示すためこの章にも出している。",
  },
  {
