    ...
    <>
      ...
      >
        ...
        <p className="mt-3 max-w-3xl text-xs leading-relaxed text-muted-foreground">
          凡例: 実線矢印＝正史で裏付けられた継承／点線矢印＋?＝諸説あり／枠線カプセル＝皇帝（高さが在位期間）／破線枠＝非皇帝（追尊皇帝・宗室など）／◆建国・◆擁立＝先代を持たない政権の起点。短い在位が密集する期間は時間軸を局所的に引き伸ばして描いています（左の年目盛りの間隔が広がっている箇所。ノードの位置と年目盛りは常に対応します）。
        </p>
      </Section>
      <Section
        id="text"
