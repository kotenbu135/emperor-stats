      ...
      >
        <Prose>
          ...
          <p>
            ...
            方針で作っています。
            {stats.emperorCount}
            名の全員について、在位の開始日・終了日は正史原文の該当箇所を引用したうえで暦換算の計算過程まで記録しています。死因と即位の経緯には判定の根拠を述べた調査メモと出典（書名・巻）を、改元・大赦・親征などの回数系8項目には数え方と判定根拠を記した調査メモを付けています（回数系は出典欄を独立させておらず、典拠にした書名・巻は調査メモの本文に記しています）。これらの調査メモと引用はサイトの画面には出しておらず、すべて
