    ...
    <>
      ...
      <div className="px-gutter py-section md:px-gutter-wide">
        ...
        <Prose>
          ...
          <H3>即位の経緯</H3>
          <p>
            どのような経緯で皇位に就いたかを分類しています。ただしこの分類は、私たちが一人ひとりに「ふさわしいラベル」を当てて決めたものではありません。ラベルの当てはめは人によって納得が分かれるため、代わりに<strong>原典が書いている事実を独立した4つの軸に分解し、そこからラベルを機械的に導き出す</strong>方式に変えました（2026年）。
          </p>
          <p>
            4つの軸は、①<strong>君主位の出所</strong>（前代君主から継承／他政権から受禅／自立）、②<strong>即位を決めた主体</strong>（本人／先帝／第三者／史料から決着不能）、③<strong>先帝の去就</strong>（崩御／横死／生前譲位／廃位・追放）、④<strong>先帝との血縁</strong>です。この組み合わせから「世襲」「擁立」「簒奪」「内禅」「自立」「推戴」「受禅（易姓）」「継承（経緯記載なし）」というラベルが決まります。世襲は先帝が後継を定めた継承、擁立は第三者（臣下・軍・宦官・外戚・母后・宗室）が立てた場合、簒奪は前帝の位を自ら奪った場合、内禅は先帝が存命のまま自ら位を譲った場合（例：清の乾隆帝から嘉慶帝）、自立は先行する君主から位を受けず自ら称した場合、推戴はそれを他者に立てられた場合、受禅（易姓）は別姓・別政権の皇帝から位を譲られた王朝交代です。
          </p>
          <p>
          ...
          <p>
            なお、旧来の「建国」は<strong>政権の属性であって皇位の出所ではない</strong>ため軸から外しました。王朝の創始者は、前王朝から位を譲られたなら受禅（易姓）、自ら称したなら自立、他者に立てられたなら推戴に分かれます。王や節度使の位を父祖から継いで皇帝号だけを新たに称した場合（始皇帝・後唐の荘宗・西夏の李元昊など）は、皇位の出所としては継承にあたるため世襲などになり、称号を新たに称したことは別に記録しています。「復位」も分類から外し、2度目以降の即位は在位期間の情報として持たせたうえ、ラベルは初回即位の経緯で付けています（例：明の英宗）。
          </p>
          <H3>改元回数</H3>
          <p>
        ...
        <Prose>
          ...
          <p>
            ...
            <strong>判断の根拠を全部残して検証できるようにする</strong>方針で作っています。
            {stats.emperorCount}
            名の全員について、在位の開始日・終了日は正史原文の該当箇所を引用したうえで暦換算の計算過程まで記録しています。死因と即位の経緯には判定の根拠を述べた調査メモと出典（書名・巻）を、改元・大赦・親征などの回数系8項目には数え方と判定根拠を記した調査メモを付けています（回数系は出典欄を独立させておらず、典拠にした書名・巻は調査メモの本文に記しています）。これらはサイトの各皇帝の個別ページで読めるほか、
            <a
              href={`${BASE_PATH}/data/emperors.json`}
              className="underline underline-offset-2 hover:text-seal"
            >
