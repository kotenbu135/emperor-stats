      ...
      body: (
        <>
          ...
          <p>
            ...
            8601形式の日付文字列（在位開始日・終了日、生年月日・没年月日など）は同規格が定める0年を含む天文年表記（前210年＝-0209）です。したがって同じ「前210年」でも、数値フィールドは-210、日付フィールドは-0209と1つずれます。各皇帝の個別ページでは、日付の根拠にした正史原文の引用と換算の調査記録を「在位日付の典拠」として公開しています。
          </p>
        </>
      ),
    },
