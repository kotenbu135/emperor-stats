...
| 生年月日 | 人 | 365 | 170 | 0 | 195 | 46.6% |
| 没年月日 | 人 | 365 | 289 | 0 | 76 | 79.2% |
| 即位時年齢 | 人 | 365 | 176 | 0 | 189 | 48.2% |
| 没年齢 | 人 | 365 | 269 | 0 | 96 | 73.7% |
| 廟号（Issue #126） | 人 | 365 | 173 | 65 | 127 | 65.2% |
| 諡号（短縮呼称・Issue #126） | 人 | 365 | 150 | 88 | 127 | 65.2% |
| 諡号の全長形（Issue #126） | 人 | 365 | 175 | 53 | 137 | 62.5% |
| 諡号の段（Issue #126） | 人 | 365 | 161 | 128 | 76 | 79.2% |
| 第N代（Issue #24） | 在位 | 374 | 162 | 14 | 198 | 47.1% |
| 紹介文（Issue #16） | 人 | 365 | 228 | 0 | 137 | 62.5% |
...
| 順 | 作業 | 量 | 器 | 着手のしかた |
|---|---|---:|---|---|
| 1 | 2026-08-13 の決定を受けた諡の転記（偽諡・皇帝の諡でない諡） | 15セル | 残量表「決定を受けて転記する諡」 | 値と証人は読了済み。**同じ変更でゲートC（`POSTHUMOUS_STAGE_NON_IMPERIAL`）と [EMPERORS_SCHEMA](../data/schema/EMPERORS_SCHEMA.md) の手当てが要る** |
| 2 | 「読んだうえで空」の証人を書く | 48セル | 残量表「2026-08-13 の決定で『空で閉じる』と決まった名前セル」 | `read-absent` を書くだけ。追加の読解はほぼ無く、判別不能→不在確定で確定率が動く |
| 3 | 名前欄の `unknown` を読む | 867セル | Issue #126 の3節 | 種つき標本の**実在見込みは 廟号0〜21・短縮諡 約51・字 約7・幼名 約11**。**濃いのは短縮諡**なので先に読む。入口は `/name-block` |
| 4 | 諡の段の未走査9書 | 77人 | 残量表 | 書1冊ずつの走査。舊唐書の隋末群雄22・新五代史の十国20・漢書14 が大きい |
| 5 | 改元 event の元号名 `eraName` の転記 | 222 event | 残量表 | 659 event 中 437 が転記済み |
| 6 | 名前欄の検証段（別コンテキスト） | 134人＋2026-08-13 に足した欄 | 残量表 | `R-VERIFY-TIER`。**行が無いブロックは黙って未検証のまま残る**ので、ブロック行を立ててから回す |
| 7 | 紹介文の残り | 137本 | **器が無い** — Issue #16 は 2026-08-13 に COMPLETED で close 済み | 続けるなら**後継 Issue が要る**（規範は [profile-writing](process/profile-writing/README.md)・入口は `/write-profile`） |
| 8 | 生母（`kinship.json`） | 187人 | メモリ `kinship-data-research` | 宋〜清が残り。Wikidata P25 の再突合も同じ単位 |
...
**推奨の順序は 1 → 2 → 3**。1と2は読解がほぼ終わっていて確定率が即動く（合計63セル）のに対し、
3は867セル読んで実在は約90セルなので、**先に安いものを閉じてから濃いバケット（短縮諡）へ入る**。
