...
| 順 | 作業 | 量 | 器 | 着手のしかた |
|---|---|---:|---|---|
| 1 | ~~2026-08-13 の決定を受けた諡の転記（偽諡・皇帝の諡でない諡）~~ **同日に完了** | ~~15セル~~ **19セル・14人** | 残量表「決定を受けて転記する諡」 | **転記済み**（段14人・短縮呼称5人。確定率は段 77.8→79.2%・短縮呼称 64.4→65.2%）。見積もりが外れたのは短縮呼称5人ぶんを数えていなかったため。**検証段は未実施** |
