...
- **可視化の第1世代**: 2026-07-22 に方式③「全体1画面のインタラクティブグラフ」＋縦軸=時間を決定し worktree-kinship-site で全域実装したが、**2026-07-24 ユーザー決定で全面白紙化**（求める品質〔家系図的な配置〕に達せず。ブランチは参照用保持・mainマージなし）。そこで確定した要求事項は第2世代へ引き継いだ（task.md 6-3）
