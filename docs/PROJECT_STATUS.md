...
| 廟号（Issue #126） | 人 | 365 | 174 | 65 | 126 | 65.5% |
| 諡号（短縮呼称・Issue #126） | 人 | 365 | 151 | 134 | 80 | 78.1% |
| 諡号の全長形（Issue #126） | 人 | 365 | 175 | 53 | 137 | 62.5% |
| 諡号の段（Issue #126） | 人 | 365 | 182 | 182 | 1 | 99.7% |
...
| 3 | 名前欄の `unknown` を読む | 838セル | Issue #126 の3節 | **2026-08-14 に短縮諡を29人ぶん閉じて数え直した**（下の節）。実在見込みは 廟号0〜21・字 約7・幼名 約11 で、**短縮諡の「約51」は無効**（残り80人は `posthumousNameFull` を1人も持たず、見積もりの根拠だった層が母集団から抜けた）。**新しい見積もりは出していない** — 着手時に `scripts/screens/` へ絞り込みを1本コミットし、当たり0の側から種つき標本を引いて取りこぼし率を測ってから読む。入口は `/name-block` |
...
| 6 | 名前欄の検証段（別コンテキスト） | 134人＋2026-08-13 の欄＋**2026-08-14 の43人＋29人** | 残量表 | `R-VERIFY-TIER`。**行が無いブロックは黙って未検証のまま残る**ので、ブロック行を立ててから回す。2026-08-14 のぶんは厚みが書で割れる（本紀が独立する北史3・新元史1・宋史16・金史6は1体、列傳・紀傳・編年・世家に依存する舊唐書23・明史8・小腆紀傳4＋2・資治通鑑4・新五代史5は3体） |
...
**残り80人は `posthumousNameFull` を1人も持たない**ので、次からは
「書がこの人物に諡を与えているか」を原文で読む作業だけになる。
**新しい見積もりは出していない** — `_corpus_cache` を「谥／諡」で全数走査すると
**要読解23人・当たり0が56人・キャッシュ無し1人**に割れるが、これは読む順序を決めるための
仕分けであって、**当たり0の56人を「値が無い」と読んではいけない**（`R-SCREEN-FIRST` 後段）。
着手時に絞り込みを `scripts/screens/` へ1本コミットし、当たり0の側から種つき標本を引いて
取りこぼし率を測ってから読み始める。
