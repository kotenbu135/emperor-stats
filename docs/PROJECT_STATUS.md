...
| 生母（kinship） | 人 | 365 | 178 | 74 | 113 | 0 | 69.0% |
...
| 8 | 生母（`kinship.json`） | **113人** | [Issue #171](https://github.com/kotenbu135/emperor-stats/issues/171)（量は残量表） | 唐末群雄7・宋遼西夏金52・元18・明22・清14。**187人から減ったのは読んだからではなく数え方を変えたから** — 原典を読んで「記載が無い」と確定した74人（`meta.confirmedMotherUnknown`）を 2026-08-17 のユーザー決定で不在確定に立てた（確定率 48.8%→69.0%）。Wikidata P25 の再突合も同じ単位 |
...
- **生母（maternalLineage）の残り113人は [Issue #171](https://github.com/kotenbu135/emperor-stats/issues/171)**（唐末群雄・宋遼西夏金・元・明・清）。ブロック16（十国）まで完了
