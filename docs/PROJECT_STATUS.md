...
データ確定と同日にサイト実装（`site/`）が完了した。技術構成・開発コマンドは [site/AGENTS.md](../site/AGENTS.md)、設計の方針・規範は [site-design/LAYOUT.md](site-design/LAYOUT.md)、実装の経緯は同ディレクトリの PERFORMANCE.md・IMPLEMENTATION_LOG.md・REDESIGN_2026-07.md を参照。
