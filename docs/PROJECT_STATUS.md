...
| 字（Issue #126） | 人 | 365 | 136 | 211 | 17 | 1 | 95.3% |
| 幼名（Issue #126） | 人 | 365 | 56 | 176 | 132 | 1 | 63.7% |
...
| 3 | 名前欄の `unknown` を読む | 758セル | Issue #126 の3節 | **2026-08-14 に短縮諡を読み切った**（29人＋80人＝袁世凱を除く全員・下の節）。**確定率 70.1%→78.1%→99.7%**。残るのは 廟号126（実在見込み0〜21）・字216（約7）・幼名318（約11）。入口は `/name-block` |
