...
| 諡号の段（Issue #126） | 人 | 365 | 162 | 127 | 76 | 79.2% |
...
**1と2は 2026-08-13 に閉じた**（諡号（短縮呼称）の確定率 64.4%→70.1%・諡の段 77.8%→79.2%）。
**次は 3**（867セル読んで実在は約90セル）だが、その前に**4の未走査9書**を見ておく価値がある —
2で分かったとおり、**短縮呼称は書1冊の走査で政権ぐるみ閉じることがあり、人物単位で読むより桁で安い**
（遼元17セルは断片17件ではなく政権記録2件で閉じた）。3の「短縮諡 約51」も、
残る15書のうち何冊かは同じ手で消える見込み。
