...
# **辞書に載っていない1字でもここへ来る**（2026-08-07）。1字の親文字は「この本文の中で
# 1度でもルビを振った語」からも要求されるので、姓が1字の人物（元・高・代・于…）を
# `profile_name.py` の指定どおり ｜元《げん》｜宏《こう》 と書いた瞬間、同じ本の
# 「改元」「元年」「元号」まで熟語の中として扱われる。北魏10人のバッチでは10体中6体が
# これを報告し、しかも check_profile_fragment.py も同じ規則で要求するため
# **正しい日本語に直すとゲートが落ちる**という袋小路になっていた。
# ここへ足せる語は「**ルビが要らないと言い切れる一般語**」だけ（伏せると辞書の語も
# 当たらなくなるので、「宗室」「高麗」のようにルビを振りたい語は入れずに辞書側で長く取る）。
NOT_TERMS: tuple[str, ...] = (
    ...
    "沛然",
    "妍を",
    "改元", "元年", "元号", "元服", "元来", "元帥", "紀元", "地元", "復元", "還元",
    "初代", "交代", "時代", "世代", "現代", "古代", "年代", "代わ", "代え", "代表",
    "高騰", "高い", "高く", "高ま", "高め", "最高", "高官", "高齢", "高価",
)
