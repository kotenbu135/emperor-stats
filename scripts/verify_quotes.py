...
COURTESY_ALLOW = {
    ...
    "liang-xiaoyuanming":
        ...
        "**この1件だけ巻番号を書いていない** — daizhige の南史は本文の巻見出しが卷二十二で"
        "途切れていて `book_volumes.daizhige_spans` が0巻を返し、china-history 側も南史は"
        "卷一〜十（本紀）しか無い。**どちらのコーパスからも機械で巻が引けないので、"
        "手で書かずに file と行で押さえた**（2026-08-16・字ブロック4）",
    "han-gaozu":
