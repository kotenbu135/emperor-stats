...
字数は3〜4字が84件で最頻・18字以上が36件（唐宋明清の加上）。
  ...
  人物
   ...
   │                2026-08-15 に28人を読み切った。**「本人の条が本人のキャッシュに
   │                在る」ことは意味しない** — 後趙 石虎の当たりは祖父への追尊
   │                （「追尊祖…为武皇帝」）で、本人の授与は石遵即位後の記事＝在位分で
   │                切ったキャッシュの外に在った（28人で1件）。陳 武帝も冒頭定型が
   │                巻二から始まるキャッシュの外だった。**このバケットが言うのは
   │                「先に読む価値がある」までで、証人の所在はキャッシュに閉じない**
